...
function App() {
  ...
  //const carruselPicturesURL = [{ href: '', urlImage: 'aa' }];
  //#endregion
  //#region methods
  useEffect(() => {
    ...
    <div className="App">
      ...
      <section>
        <div className="row carro ">
          <div className="col-md-5 m-0 p-0 a-l-2 text-end">
            ...
            <img src={require('./assets/img/All/logo.png')} className="img-fluid" alt="..." />
      ...
      <div className="container justify-content-center a-b-2" >
        <div className="row ">
          ...
          <div className="col d-flex justify-content-center">
            <a href="http://dev-cfdi4.ntlink.com.mx" target="_blank" className="mbtn buttonexapnd"  ><span className="mb-0">DOCUMENTACIÓN</span></a>
          </div>
        </div>
      </div>
      {
      ...
      <Modal.Body className='preciosBackPop'>
        <div className="container ">
          <div className="row justify-content-center text-center">
            <img src={require('./assets/img/All/precios_head.png')} className="img-fluid" alt="..." />
        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-md-7">
              ...
              <form id="contact-form" className="item-form " action='' onSubmit={(e) => {
                e.preventDefault();
